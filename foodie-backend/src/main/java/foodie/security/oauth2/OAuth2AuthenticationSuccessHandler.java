...
import static foodie.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
import foodie.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	private boolean isAuthorizedRedirectUri(String uri) {
		...
		System.out.println(appProperties.getOauth2().getAuthorizedRedirectUris().get(0));
